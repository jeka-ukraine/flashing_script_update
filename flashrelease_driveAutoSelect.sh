...
if [[ $1 =~ $VAN_regex ]];
then
        prefix="$output_dir/Tools/Autogrator/resources/cards/Mfa2H2RH850Firmwarev${H2RH850_version}/master/lin_opt/BIN/MFA2_VANS_B3/"
        #echo "VANs prefix"
else
        prefix="$output_dir/Tools/Autogrator/resources/cards/Mfa2H2RH850Firmwarev${H2RH850_version}/master/lin_opt/BIN/MFA2_C5_B3/"
        #echo "CARs prefix"
fi
